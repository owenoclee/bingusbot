tool = {
    name = "schedule_wake",
    description = "Schedule when to wake up next to check in or act on something. Only one wake can be pending at a time (overwrites previous). Min 1 minute, max 7 days.",
